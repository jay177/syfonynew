 ...
 */
final class Version20230322084120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE remontées (id INT AUTO_INCREMENT NOT NULL, station_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, open TINYINT(1) DEFAULT NULL, horaire VARCHAR(255) DEFAULT NULL, message LONGTEXT DEFAULT NULL, INDEX IDX_6CA9C01821BDB235 (station_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE remontées ADD CONSTRAINT FK_6CA9C01821BDB235 FOREIGN KEY (station_id) REFERENCES station (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE remontées DROP FOREIGN KEY FK_6CA9C01821BDB235');
        ...
        $this->addSql('DROP TABLE remontées');
